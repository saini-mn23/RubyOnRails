class AdvertisementsController < ApplicationController
 ...
 # GET /advertisements or /advertisements.json
  ...
  #   redirect_to advertisements_path, notice: "Not authorized to edit this friend" if @advertisement.nil?
  # end
  ...
  private
    ...
    def advertisement_params
      params.require(:advertisement).permit(:image, :title, :description)
    end
end
